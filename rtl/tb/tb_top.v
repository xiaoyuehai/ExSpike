...
// Description: Top-level simulation testbench for EVENT_PROCESSOR_TOP.
// -----------------------------------------------------------------------------
...
`ifndef SEG_NET
	...
	`endif
		...
		initial begin
			$sformat(latency_file, "reports/latency_report_group_%0d.txt", `GROUP_NUMBER);
	...
	`ifdef ST2_CIFAR100
			...
			if (figure8_enable) begin
				$sformat(figure8_file, "reports/figure8_group_%0d.txt", `GROUP_NUMBER);
